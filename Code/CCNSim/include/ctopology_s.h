...
#ifndef __cTopology_s_H
#define __cTopology_s_H



#include "D:\omnetpp-4.6\tools\win32\mingw32\include\c++\4.9.2\bits\algorithmfwd.h"
#include <string>
#include <vector>
...
/**
 * Routing support. The cTopology_s class was designed primarily to support
 * routing in telecommunication or multiprocessor networks.
 *
 * A cTopology_s object stores an abstract representation of the network
 * in graph form:
 * <UL>
 *   <LI> each cTopology_s node corresponds to a getModule(simple or compound), and
 *   <LI> each cTopology_s edge corresponds to a link or series of connecting links.
 * </UL>
 *
 ...
 *
 * @ingroup SimSupport
 * @see cTopology_s::Node, cTopology_s::Link, cTopology_s::LinkIn, cTopology_s::LinkOut
 */
#include<list>
#include <deque>
class SIM_API cTopology_s : public cOwnedObject
{
  public:
    class Link;
    class LinkIn;
    ...
    /**
     * Supporting class for cTopology_s, represents a node in the graph.
     */
    class SIM_API Node
    {
        friend class cTopology_s;
	...
	double delta;
      ...
      public:
         ...
         * weighted shortest path finder methods of cTopology_s.
         */
    ...
    /**
     * Supporting class for cTopology_s, represents a link in the graph.
     */
    class SIM_API Link
    {
        friend class cTopology_s;
    ...
    /**
     * Supporting class for cTopology_s.
     *
     * While navigating the graph stored in a cTopology_s, Node's methods return
    ...
    /**
     * Base class for selector objects used in extract...() methods of cTopology_s.
  ...
  public:
     ...
     * Constructor.
     */
    explicit cTopology_s(const char *name=NULL);

    /**
     * Copy constructor.
     */
    cTopology_s(const cTopology_s& topo);
     ...
     */
    cTopology_s& operator=(const cTopology_s& topo);
    //@}
     ...
     */
    virtual cTopology_s *dup() const  {return new cTopology_s(*this);}
